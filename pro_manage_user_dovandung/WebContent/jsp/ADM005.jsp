...
<!-- Begin vung input-->
	...
	<input type="hidden" name="accessType" value="edit"></input>
			...
			<td align="left" >
				<div style="padding-left:100px;">
					...
					<tr class="japanInfor" style="display: none;">
						...
						<td align="left">
						<c:if test="${userInfor.startDate!=null}">${userInfor.startDate.year}/${userInfor.startDate.month}/${userInfor.startDate.day}
							</c:if>
						</td>
					</tr>
					<tr class="japanInfor" style="display: none;">
						...
						<td align="left">
						<c:if test="${userInfor.endDate!=null}">${userInfor.endDate.year}/${userInfor.endDate.month}/${userInfor.endDate.day}
							</c:if>
						</td>
					</tr>
					<tr class="japanInfor" style="display: none;">
	...
	<table border="0" cellpadding="4" cellspacing="0" width="300px">
		<tr>
			...
			<td>
				<input class="btn" type="button" value="削除" onclick="javascript:confirmDeleteUser(${userInfor.userId})" />
			</td>
			<td>
				<input class="btn" type="button" value="戻る" onclick="location.href='ListUser.do?userId=${userInfor.userId}&accessType=edit'" />
			</td>
		</tr>
	</table>
	<!-- End vung button -->
